...
import boatImg from '../images/boats.jpg'
  ...
  return (
    <div name='support' className='w-full mt-24'>
        <div className='w-full h-[700px] bg-gray-900/90 absolute'>
          <img className='w-full h-full object-cover mix-blend-overlay' src={boatImg} alt="/" />
        </div>
        ...
        <div className='max-w-[1240px] mx-auto text-white relative'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                <div className='bg-white rounded-xl shadow-2xl'>
                    <div className='p-8'>
                    <BsFillGearFill  className='w-16 p-4 bg-indigo-600  text-white rounded-lg mt-[-3rem]'/>
                    ...
                    <div className='bg-slate-100 pl-8 py-4'>
                        <p className='flex items-center text-indigo-600'>Contact Us <BsFillGearFill className='w-5 ml-2' /></p>
                    </div>
                </div>
                <div className='bg-white rounded-xl shadow-2xl'>
                    <div className='p-8'>
                    <BsFillGearFill  className='w-16 p-4 bg-indigo-600  rounded-lg mt-[-3rem]'/>
                ...
                <div className='bg-white rounded-xl shadow-2xl'>
                    <div className='p-8'>
                    <BsFillGearFill  className='w-16 p-4 bg-indigo-600  relative rounded-lg mt-[-3rem]'/>
